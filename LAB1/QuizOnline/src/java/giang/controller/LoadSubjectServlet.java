...
public class LoadSubjectServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean result = dao.loadSubject();
            ArrayList<String> subjectList = dao.getList();
...
//            request.setAttribute("SUBJECTLIST", subjectList);
            ...
            log("LoadSubjectServlet _ Naming _ " + ex.getMessage());
        } catch (SQLException ex) {
            log("LoadSubjectServlet _ SQL _ " + ex.getMessage());
        } finally {
