<%-- 
    Document   : history
    Created on : Jul 17, 2020, 10:58:57 PM
    Author     : Ninh Giang
--%>
    ...
    <body>
        ...
        <s:if test="%{#session['FULLNAME'] != null}">
            ...
            <s:if test="%{#session['ROLE'].equals('Manager')}">
                <p>Manager Cannot See Request History.</p>
                <a href="dashboard.jsp">Back to Dashboard Here</a>
            </s:if>
            <s:else>
                <s:form action="loadhistory">
                ...
                <s:if test="%{PAGEQUANTITY != null}">
                    <s:iterator var="pagingBtn" begin="1" end="%{PAGEQUANTITY}">
                        <s:url action="loadhistory" id="searchURL">
                            <s:param name="pageNum" value="%{pagingBtn}"/>
                            <s:param name="txtUserName" value="%{session['USERID']}"/>
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <s:iterator value="list" status="counter">
                                <s:form action="deletereq" theme="simple">
                                    <tr>
                                        <td>
